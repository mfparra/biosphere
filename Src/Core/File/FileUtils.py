...
class FileUtils:
    ...
    @staticmethod
    def get_with_pagginate(directory:str,  page_size:int, current_page:int, page_count:int, pattern:str=None,
        ...
        current_page += 1
        result_list = [(FileUtils.get_file_name(file), FileUtils.read(path.join(directory, file))) for file in file_list]
