...
from Src.BioDataFileManagement.CrossCutting.Filters.FeListDnaMethylationSampleFile import FeListDnaMethylationFileSample


class FeListFileDnaMethylationTests(unittest.TestCase):
    def test_instance(self):
        filter = FeListDnaMethylationFileSample(pattern='\S+.*\.txt')
